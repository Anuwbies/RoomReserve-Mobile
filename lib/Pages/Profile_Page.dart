...
// Moved constants to top-level so all widgets in this file can access them
    ...
    return Material(
      ...
      child: InkWell(
        ...
        borderRadius: isLast
            ...
            : const BorderRadius.vertical(top: Radius.circular(16)), // Just for corner smoothing
        child: Column(
          children: [
            Padding(
            ...
            if (!isLast)
              Divider(
                height: 1,
                indent: 70, // Align divider with text start
                thickness: 0.5,
